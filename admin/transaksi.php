            ...
            <div class="card-body">
              <form action="" method="POST">
                <div class="form-group mb-2 row">
                  <label for="search" class="col-sm-auto col-form-label">Total Bayar</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control-sm form-control" id="totalmin" name="totalmin" placeholder="Rp. Min">
                  </div>
                  <div class="col-sm-4">
                    <input type="text" class="form-control-sm form-control" id="totalmax" name="totalmax" placeholder="Rp. Max">
                  </div>
