...
$result = mysqli_query($conn, "SELECT pengguna.*, level.nama nama_level FROM pengguna JOIN level ON pengguna.level_id = level.id WHERE pengguna.id = $id"); 
